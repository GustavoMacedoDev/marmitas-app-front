...
@Component({
  selector: 'app-prato-pedido-cliente',
  templateUrl: './prato-pedido-cliente.component.html',
  styleUrls: ['./prato-pedido-cliente.component.css'],
  animations: [
    trigger('row', [
...
export class PratoPedidoClienteComponent implements OnInit {
